...
object BlackMass {
  ...
  def apply(resources : GraphicResourceBase, source : Vector2, target : Vector2, targetDim : Vector2) = {
...
class BlackMass(pos: Vector2, target : Vector2, targetDim : Vector2, timedComponent : TimedComponent, resources : GraphicResourceBase)
  extends Drawable {
